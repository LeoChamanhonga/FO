...
<div style="height: 500px;" class="ph card card-content card-overflow" id="b7-Content">
    ...
    <a data-link="" class="ThemeGrid_MarginGutter" href="downalod_excel_filtro.php?obra=<?php echo $ids_obra?>" download="Obra_filtrada.xlsx">
        <i data-icon="" class="icon fa fa-file-excel-o fa-2x"></i>
</a>
</div>
...
<button data-toggle="modal" data-target="#exampleModal" data-iduser="<?php echo $row['id_colaborador']; ?>" type="button" style="color: rgb(99, 188, 129); font-size: 32px;">
    <i data-icon="" class="icon  fa fa-plus fa-2x ThemeGrid_MarginGutter" style="color: rgb(99, 188, 129); font-size: 32px;"></i></button>
</div>
</div>
</div>
